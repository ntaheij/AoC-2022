# Part 1 + 2
def move_rope_with_n_knots(data, num_knots):
    direction_map = {'U': [0, 1], 'D': [0, -1], 'R': [1, 0], 'L': [-1, 0]}
    directions_to_follow = data
...
if __name__ == "__main__":
    with open("inputs/input.txt") as file:
        ...
        # Part 1
        print(move_rope_with_n_knots(directions, num_knots=2))

        # Part 2
        print(move_rope_with_n_knots(directions, num_knots=10))